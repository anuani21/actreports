...
Current Store : [0x80000580] : sw s1, 100(t0) -- Store: [0x80002350]:0x00000010




Last Coverpoint : ['mnemonic : fcvt.wu.h', 'rs1 : f31', 'rd : x31', 'fs1 == 1 and fe1 == 0x0b and fm1 == 0x136 and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat']
Last Code Sequence : 
	-[0x80000590]:fcvt.wu.h t6, ft11, dyn
	-[0x80000594]:csrrs s1, fcsr, zero
	-[0x80000598]:sw t6, 104(t0)
...
|---:|--------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------|
|   1|[0x80002214]<br>0xFFFFFFFF|- mnemonic : fcvt.wu.h<br> - rs1 : f31<br> - rd : x31<br> - fs1 == 0 and fe1 == 0x0c and fm1 == 0x249 and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br> |[0x80000120]:fcvt.wu.h t6, ft11, dyn<br> [0x80000124]:csrrs tp, fcsr, zero<br> [0x80000128]:sw t6, 0(ra)<br>     |
|   2|[0x8000221c]<br>0xFFFFFFFF|- rs1 : f30<br> - rd : x30<br> - fs1 == 0 and fe1 == 0x0d and fm1 == 0x1b7 and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                            |[0x8000013c]:fcvt.wu.h t5, ft10, dyn<br> [0x80000140]:csrrs tp, fcsr, zero<br> [0x80000144]:sw t5, 8(ra)<br>     |
|   3|[0x80002224]<br>0xFFFFFFFF|- rs1 : f29<br> - rd : x29<br> - fs1 == 0 and fe1 == 0x0e and fm1 == 0x24f and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                            |[0x80000158]:fcvt.wu.h t4, ft9, dyn<br> [0x8000015c]:csrrs tp, fcsr, zero<br> [0x80000160]:sw t4, 16(ra)<br>     |
|   4|[0x8000222c]<br>0xFFFFFFFF|- rs1 : f28<br> - rd : x28<br> - fs1 == 0 and fe1 == 0x0f and fm1 == 0x0d3 and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                            |[0x80000174]:fcvt.wu.h t3, ft8, dyn<br> [0x80000178]:csrrs tp, fcsr, zero<br> [0x8000017c]:sw t3, 24(ra)<br>     |
|   5|[0x80002234]<br>0xFFFFFFFF|- rs1 : f27<br> - rd : x27<br> - fs1 == 0 and fe1 == 0x10 and fm1 == 0x340 and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                            |[0x80000190]:fcvt.wu.h s11, fs11, dyn<br> [0x80000194]:csrrs tp, fcsr, zero<br> [0x80000198]:sw s11, 32(ra)<br>  |
|   6|[0x8000223c]<br>0xFFFFFFFF|- rs1 : f26<br> - rd : x26<br> - fs1 == 0 and fe1 == 0x11 and fm1 == 0x34b and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                            |[0x800001ac]:fcvt.wu.h s10, fs10, dyn<br> [0x800001b0]:csrrs tp, fcsr, zero<br> [0x800001b4]:sw s10, 40(ra)<br>  |
|   7|[0x80002244]<br>0xFFFFFFFF|- rs1 : f25<br> - rd : x25<br> - fs1 == 1 and fe1 == 0x12 and fm1 == 0x29d and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                            |[0x800001c8]:fcvt.wu.h s9, fs9, dyn<br> [0x800001cc]:csrrs tp, fcsr, zero<br> [0x800001d0]:sw s9, 48(ra)<br>     |
|   8|[0x8000224c]<br>0xFFFFFFFF|- rs1 : f24<br> - rd : x24<br> - fs1 == 0 and fe1 == 0x13 and fm1 == 0x0a4 and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                            |[0x800001e4]:fcvt.wu.h s8, fs8, dyn<br> [0x800001e8]:csrrs tp, fcsr, zero<br> [0x800001ec]:sw s8, 56(ra)<br>     |
|   9|[0x80002254]<br>0xFFFFFFFF|- rs1 : f23<br> - rd : x23<br> - fs1 == 0 and fe1 == 0x14 and fm1 == 0x215 and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                            |[0x80000200]:fcvt.wu.h s7, fs7, dyn<br> [0x80000204]:csrrs tp, fcsr, zero<br> [0x80000208]:sw s7, 64(ra)<br>     |
|  10|[0x8000225c]<br>0xFFFFFFFF|- rs1 : f22<br> - rd : x22<br> - fs1 == 0 and fe1 == 0x15 and fm1 == 0x14f and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                            |[0x8000021c]:fcvt.wu.h s6, fs6, dyn<br> [0x80000220]:csrrs tp, fcsr, zero<br> [0x80000224]:sw s6, 72(ra)<br>     |
|  11|[0x80002264]<br>0xFFFFFFFF|- rs1 : f21<br> - rd : x21<br> - fs1 == 1 and fe1 == 0x16 and fm1 == 0x0ff and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                            |[0x80000238]:fcvt.wu.h s5, fs5, dyn<br> [0x8000023c]:csrrs tp, fcsr, zero<br> [0x80000240]:sw s5, 80(ra)<br>     |
|  12|[0x8000226c]<br>0xFFFFFFFF|- rs1 : f20<br> - rd : x20<br> - fs1 == 1 and fe1 == 0x17 and fm1 == 0x3cf and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                            |[0x80000254]:fcvt.wu.h s4, fs4, dyn<br> [0x80000258]:csrrs tp, fcsr, zero<br> [0x8000025c]:sw s4, 88(ra)<br>     |
|  13|[0x80002274]<br>0xFFFFFFFF|- rs1 : f19<br> - rd : x19<br> - fs1 == 0 and fe1 == 0x18 and fm1 == 0x3fc and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                            |[0x80000270]:fcvt.wu.h s3, fs3, dyn<br> [0x80000274]:csrrs tp, fcsr, zero<br> [0x80000278]:sw s3, 96(ra)<br>     |
|  14|[0x8000227c]<br>0xFFFFFFFF|- rs1 : f18<br> - rd : x18<br> - fs1 == 0 and fe1 == 0x19 and fm1 == 0x02d and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                            |[0x8000028c]:fcvt.wu.h s2, fs2, dyn<br> [0x80000290]:csrrs tp, fcsr, zero<br> [0x80000294]:sw s2, 104(ra)<br>    |
|  15|[0x80002284]<br>0xFFFFFFFF|- rs1 : f17<br> - rd : x17<br> - fs1 == 0 and fe1 == 0x1a and fm1 == 0x370 and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                            |[0x800002a8]:fcvt.wu.h a7, fa7, dyn<br> [0x800002ac]:csrrs tp, fcsr, zero<br> [0x800002b0]:sw a7, 112(ra)<br>    |
|  16|[0x8000228c]<br>0xFFFFFFFF|- rs1 : f16<br> - rd : x16<br> - fs1 == 0 and fe1 == 0x1b and fm1 == 0x269 and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                            |[0x800002c4]:fcvt.wu.h a6, fa6, dyn<br> [0x800002c8]:csrrs tp, fcsr, zero<br> [0x800002cc]:sw a6, 120(ra)<br>    |
|  17|[0x80002294]<br>0xFFFFFFFF|- rs1 : f15<br> - rd : x15<br> - fs1 == 0 and fe1 == 0x1c and fm1 == 0x186 and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                            |[0x800002e0]:fcvt.wu.h a5, fa5, dyn<br> [0x800002e4]:csrrs tp, fcsr, zero<br> [0x800002e8]:sw a5, 128(ra)<br>    |
|  18|[0x8000229c]<br>0xFFFFFFFF|- rs1 : f14<br> - rd : x14<br> - fs1 == 1 and fe1 == 0x1d and fm1 == 0x122 and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                            |[0x800002fc]:fcvt.wu.h a4, fa4, dyn<br> [0x80000300]:csrrs tp, fcsr, zero<br> [0x80000304]:sw a4, 136(ra)<br>    |
|  19|[0x800022a4]<br>0xFFFFFFFF|- rs1 : f13<br> - rd : x13<br> - fs1 == 0 and fe1 == 0x1e and fm1 == 0x2b3 and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                            |[0x80000318]:fcvt.wu.h a3, fa3, dyn<br> [0x8000031c]:csrrs tp, fcsr, zero<br> [0x80000320]:sw a3, 144(ra)<br>    |
|  20|[0x800022ac]<br>0xFFFFFFFF|- rs1 : f12<br> - rd : x12<br> - fs1 == 0 and fe1 == 0x1e and fm1 == 0x3ff and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                            |[0x80000334]:fcvt.wu.h a2, fa2, dyn<br> [0x80000338]:csrrs tp, fcsr, zero<br> [0x8000033c]:sw a2, 152(ra)<br>    |
|  21|[0x800022b4]<br>0xFFFFFFFF|- rs1 : f11<br> - rd : x11<br> - fs1 == 1 and fe1 == 0x00 and fm1 == 0x2be and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                            |[0x80000350]:fcvt.wu.h a1, fa1, dyn<br> [0x80000354]:csrrs tp, fcsr, zero<br> [0x80000358]:sw a1, 160(ra)<br>    |
|  22|[0x800022bc]<br>0xFFFFFFFF|- rs1 : f10<br> - rd : x10<br> - fs1 == 1 and fe1 == 0x01 and fm1 == 0x2a5 and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                            |[0x8000036c]:fcvt.wu.h a0, fa0, dyn<br> [0x80000370]:csrrs tp, fcsr, zero<br> [0x80000374]:sw a0, 168(ra)<br>    |
|  23|[0x800022c4]<br>0xFFFFFFFF|- rs1 : f9<br> - rd : x9<br> - fs1 == 1 and fe1 == 0x02 and fm1 == 0x088 and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                              |[0x80000388]:fcvt.wu.h s1, fs1, dyn<br> [0x8000038c]:csrrs tp, fcsr, zero<br> [0x80000390]:sw s1, 176(ra)<br>    |
|  24|[0x800022cc]<br>0xFFFFFFFF|- rs1 : f8<br> - rd : x8<br> - fs1 == 1 and fe1 == 0x03 and fm1 == 0x312 and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                              |[0x800003a4]:fcvt.wu.h fp, fs0, dyn<br> [0x800003a8]:csrrs tp, fcsr, zero<br> [0x800003ac]:sw fp, 184(ra)<br>    |
|  25|[0x800022d4]<br>0xFFFFFFFF|- rs1 : f7<br> - rd : x7<br> - fs1 == 1 and fe1 == 0x04 and fm1 == 0x3ed and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                              |[0x800003c8]:fcvt.wu.h t2, ft7, dyn<br> [0x800003cc]:csrrs s1, fcsr, zero<br> [0x800003d0]:sw t2, 192(ra)<br>    |
|  26|[0x800022dc]<br>0xFFFFFFFF|- rs1 : f6<br> - rd : x6<br> - fs1 == 1 and fe1 == 0x05 and fm1 == 0x3e0 and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                              |[0x800003e4]:fcvt.wu.h t1, ft6, dyn<br> [0x800003e8]:csrrs s1, fcsr, zero<br> [0x800003ec]:sw t1, 200(ra)<br>    |
|  27|[0x800022e4]<br>0xFFFFFFFF|- rs1 : f5<br> - rd : x5<br> - fs1 == 1 and fe1 == 0x06 and fm1 == 0x274 and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                              |[0x80000400]:fcvt.wu.h t0, ft5, dyn<br> [0x80000404]:csrrs s1, fcsr, zero<br> [0x80000408]:sw t0, 208(ra)<br>    |
|  28|[0x800022ec]<br>0xFFFFFFFF|- rs1 : f4<br> - rd : x4<br> - fs1 == 1 and fe1 == 0x07 and fm1 == 0x02d and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                              |[0x80000424]:fcvt.wu.h tp, ft4, dyn<br> [0x80000428]:csrrs s1, fcsr, zero<br> [0x8000042c]:sw tp, 0(t0)<br>      |
|  29|[0x800022f4]<br>0xFFFFFFFF|- rs1 : f3<br> - rd : x3<br> - fs1 == 1 and fe1 == 0x08 and fm1 == 0x004 and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                              |[0x80000440]:fcvt.wu.h gp, ft3, dyn<br> [0x80000444]:csrrs s1, fcsr, zero<br> [0x80000448]:sw gp, 8(t0)<br>      |
|  30|[0x800022fc]<br>0xFFFFFFFF|- rs1 : f2<br> - rd : x2<br> - fs1 == 1 and fe1 == 0x09 and fm1 == 0x089 and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                              |[0x8000045c]:fcvt.wu.h sp, ft2, dyn<br> [0x80000460]:csrrs s1, fcsr, zero<br> [0x80000464]:sw sp, 16(t0)<br>     |
|  31|[0x80002304]<br>0xFFFFFFFF|- rs1 : f1<br> - rd : x1<br> - fs1 == 1 and fe1 == 0x0a and fm1 == 0x3c3 and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                              |[0x80000478]:fcvt.wu.h ra, ft1, dyn<br> [0x8000047c]:csrrs s1, fcsr, zero<br> [0x80000480]:sw ra, 24(t0)<br>     |
|  32|[0x8000230c]<br>0x00000000|- rs1 : f0<br> - rd : x0<br> - fs1 == 1 and fe1 == 0x0b and fm1 == 0x136 and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                              |[0x80000494]:fcvt.wu.h zero, ft0, dyn<br> [0x80000498]:csrrs s1, fcsr, zero<br> [0x8000049c]:sw zero, 32(t0)<br> |
|  33|[0x80002314]<br>0xFFFFFFFF|- fs1 == 1 and fe1 == 0x0c and fm1 == 0x176 and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                                                           |[0x800004b0]:fcvt.wu.h t6, ft11, dyn<br> [0x800004b4]:csrrs s1, fcsr, zero<br> [0x800004b8]:sw t6, 40(t0)<br>    |
|  34|[0x8000231c]<br>0xFFFFFFFF|- fs1 == 1 and fe1 == 0x0d and fm1 == 0x397 and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                                                           |[0x800004cc]:fcvt.wu.h t6, ft11, dyn<br> [0x800004d0]:csrrs s1, fcsr, zero<br> [0x800004d4]:sw t6, 48(t0)<br>    |
|  35|[0x80002324]<br>0xFFFFFFFF|- fs1 == 1 and fe1 == 0x0e and fm1 == 0x141 and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                                                           |[0x800004e8]:fcvt.wu.h t6, ft11, dyn<br> [0x800004ec]:csrrs s1, fcsr, zero<br> [0x800004f0]:sw t6, 56(t0)<br>    |
|  36|[0x8000232c]<br>0xFFFFFFFF|- fs1 == 1 and fe1 == 0x0f and fm1 == 0x232 and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                                                           |[0x80000504]:fcvt.wu.h t6, ft11, dyn<br> [0x80000508]:csrrs s1, fcsr, zero<br> [0x8000050c]:sw t6, 64(t0)<br>    |
|  37|[0x80002334]<br>0xFFFFFFFF|- fs1 == 1 and fe1 == 0x10 and fm1 == 0x1be and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                                                           |[0x80000520]:fcvt.wu.h t6, ft11, dyn<br> [0x80000524]:csrrs s1, fcsr, zero<br> [0x80000528]:sw t6, 72(t0)<br>    |
|  38|[0x8000233c]<br>0xFFFFFFFF|- fs1 == 1 and fe1 == 0x11 and fm1 == 0x042 and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                                                           |[0x8000053c]:fcvt.wu.h t6, ft11, dyn<br> [0x80000540]:csrrs s1, fcsr, zero<br> [0x80000544]:sw t6, 80(t0)<br>    |
|  39|[0x80002344]<br>0xFFFFFFFF|- fs1 == 1 and fe1 == 0x09 and fm1 == 0x256 and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                                                           |[0x80000558]:fcvt.wu.h t6, ft11, dyn<br> [0x8000055c]:csrrs s1, fcsr, zero<br> [0x80000560]:sw t6, 88(t0)<br>    |
|  40|[0x8000234c]<br>0xFFFFFFFF|- fs1 == 1 and fe1 == 0x16 and fm1 == 0x201 and  fcsr == 0x0 and rm_val == 7  and rs1_nan_prefix == 0xffff  #nosat<br>                                                           |[0x80000574]:fcvt.wu.h t6, ft11, dyn<br> [0x80000578]:csrrs s1, fcsr, zero<br> [0x8000057c]:sw t6, 96(t0)<br>    |
