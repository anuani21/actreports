...
|---:|--------------------------|-------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------|
|   1|[0x80002214]<br>0x000077FC|- mnemonic : fmv.x.h<br> - rs1 : f31<br> - rd : x31<br> - fs1 == 0 and fe1 == 0x1d and fm1 == 0x3fc and  fcsr == 0  #nosat<br> |[0x80000120]:fmv.x.h t6, ft11<br> [0x80000124]:csrrs tp, fcsr, zero<br> [0x80000128]:sw t6, 0(ra)<br>     |
|   2|[0x8000221c]<br>0x000077FD|- rs1 : f30<br> - rd : x30<br> - fs1 == 0 and fe1 == 0x1d and fm1 == 0x3fd and  fcsr == 0  #nosat<br>                          |[0x8000013c]:fmv.x.h t5, ft10<br> [0x80000140]:csrrs tp, fcsr, zero<br> [0x80000144]:sw t5, 8(ra)<br>     |
|   3|[0x80002224]<br>0x000077FE|- rs1 : f29<br> - rd : x29<br> - fs1 == 0 and fe1 == 0x1d and fm1 == 0x3fe and  fcsr == 0  #nosat<br>                          |[0x80000158]:fmv.x.h t4, ft9<br> [0x8000015c]:csrrs tp, fcsr, zero<br> [0x80000160]:sw t4, 16(ra)<br>     |
|   4|[0x8000222c]<br>0x000077FF|- rs1 : f28<br> - rd : x28<br> - fs1 == 0 and fe1 == 0x1d and fm1 == 0x3ff and  fcsr == 0  #nosat<br>                          |[0x80000174]:fmv.x.h t3, ft8<br> [0x80000178]:csrrs tp, fcsr, zero<br> [0x8000017c]:sw t3, 24(ra)<br>     |
|   5|[0x80002234]<br>0x00007800|- rs1 : f27<br> - rd : x27<br> - fs1 == 0 and fe1 == 0x1e and fm1 == 0x000 and  fcsr == 0  #nosat<br>                          |[0x80000190]:fmv.x.h s11, fs11<br> [0x80000194]:csrrs tp, fcsr, zero<br> [0x80000198]:sw s11, 32(ra)<br>  |
|   6|[0x8000223c]<br>0x00007801|- rs1 : f26<br> - rd : x26<br> - fs1 == 0 and fe1 == 0x1e and fm1 == 0x001 and  fcsr == 0  #nosat<br>                          |[0x800001ac]:fmv.x.h s10, fs10<br> [0x800001b0]:csrrs tp, fcsr, zero<br> [0x800001b4]:sw s10, 40(ra)<br>  |
|   7|[0x80002244]<br>0x00007802|- rs1 : f25<br> - rd : x25<br> - fs1 == 0 and fe1 == 0x1e and fm1 == 0x002 and  fcsr == 0  #nosat<br>                          |[0x800001c8]:fmv.x.h s9, fs9<br> [0x800001cc]:csrrs tp, fcsr, zero<br> [0x800001d0]:sw s9, 48(ra)<br>     |
|   8|[0x8000224c]<br>0x00007803|- rs1 : f24<br> - rd : x24<br> - fs1 == 0 and fe1 == 0x1e and fm1 == 0x003 and  fcsr == 0  #nosat<br>                          |[0x800001e4]:fmv.x.h s8, fs8<br> [0x800001e8]:csrrs tp, fcsr, zero<br> [0x800001ec]:sw s8, 56(ra)<br>     |
|   9|[0x80002254]<br>0x00007804|- rs1 : f23<br> - rd : x23<br> - fs1 == 0 and fe1 == 0x1e and fm1 == 0x004 and  fcsr == 0  #nosat<br>                          |[0x80000200]:fmv.x.h s7, fs7<br> [0x80000204]:csrrs tp, fcsr, zero<br> [0x80000208]:sw s7, 64(ra)<br>     |
...
|  13|[0x80002274]<br>0x00000000|- rs1 : f19<br> - rd : x19<br>                                                                                                 |[0x80000270]:fmv.x.h s3, fs3<br> [0x80000274]:csrrs tp, fcsr, zero<br> [0x80000278]:sw s3, 96(ra)<br>     |
|  14|[0x8000227c]<br>0x00000000|- rs1 : f18<br> - rd : x18<br>                                                                                                 |[0x8000028c]:fmv.x.h s2, fs2<br> [0x80000290]:csrrs tp, fcsr, zero<br> [0x80000294]:sw s2, 104(ra)<br>    |
|  15|[0x80002284]<br>0x00000000|- rs1 : f17<br> - rd : x17<br>                                                                                                 |[0x800002a8]:fmv.x.h a7, fa7<br> [0x800002ac]:csrrs tp, fcsr, zero<br> [0x800002b0]:sw a7, 112(ra)<br>    |
|  16|[0x8000228c]<br>0x00000000|- rs1 : f16<br> - rd : x16<br>                                                                                                 |[0x800002c4]:fmv.x.h a6, fa6<br> [0x800002c8]:csrrs tp, fcsr, zero<br> [0x800002cc]:sw a6, 120(ra)<br>    |
