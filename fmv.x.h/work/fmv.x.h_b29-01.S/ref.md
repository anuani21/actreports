...
| COV_LABELS                | fmv.x.h_b29      |
| TEST_NAME                 | /home/anusha/new/RV32H/fmv.x.h/work/fmv.x.h_b29-01.S/ref.S    |
...
```
Last Coverpoint : ['mnemonic : fmv.x.h', 'rs1 : f31', 'rd : x31', 'fs1 == 0 and fe1 == 0x0c and fm1 == 0x248 and  fcsr == 0  #nosat']
Last Code Sequence : 
...
Last Coverpoint : ['rs1 : f30', 'rd : x30', 'fs1 == 0 and fe1 == 0x0c and fm1 == 0x249 and  fcsr == 0  #nosat']
Last Code Sequence : 
...
Last Coverpoint : ['rs1 : f29', 'rd : x29', 'fs1 == 0 and fe1 == 0x0c and fm1 == 0x24a and  fcsr == 0  #nosat']
Last Code Sequence : 
...
Last Coverpoint : ['rs1 : f28', 'rd : x28', 'fs1 == 0 and fe1 == 0x0c and fm1 == 0x24b and  fcsr == 0  #nosat']
Last Code Sequence : 
...
Last Coverpoint : ['rs1 : f27', 'rd : x27', 'fs1 == 0 and fe1 == 0x0c and fm1 == 0x24c and  fcsr == 0  #nosat']
Last Code Sequence : 
...
Last Coverpoint : ['rs1 : f26', 'rd : x26', 'fs1 == 0 and fe1 == 0x0c and fm1 == 0x24d and  fcsr == 0  #nosat']
Last Code Sequence : 
...
Last Coverpoint : ['rs1 : f25', 'rd : x25', 'fs1 == 0 and fe1 == 0x0c and fm1 == 0x24e and  fcsr == 0  #nosat']
Last Code Sequence : 
...
Last Coverpoint : ['rs1 : f24', 'rd : x24', 'fs1 == 0 and fe1 == 0x0c and fm1 == 0x24f and  fcsr == 0  #nosat']
Last Code Sequence : 
...
Last Coverpoint : ['rs1 : f23', 'rd : x23', 'fs1 == 1 and fe1 == 0x0c and fm1 == 0x248 and  fcsr == 0  #nosat']
Last Code Sequence : 
...
Last Coverpoint : ['rs1 : f22', 'rd : x22', 'fs1 == 1 and fe1 == 0x0c and fm1 == 0x249 and  fcsr == 0  #nosat']
Last Code Sequence : 
...
Last Coverpoint : ['rs1 : f21', 'rd : x21', 'fs1 == 1 and fe1 == 0x0c and fm1 == 0x24a and  fcsr == 0  #nosat']
Last Code Sequence : 
...
Last Coverpoint : ['rs1 : f20', 'rd : x20', 'fs1 == 1 and fe1 == 0x0c and fm1 == 0x24b and  fcsr == 0  #nosat']
Last Code Sequence : 
...
Last Coverpoint : ['rs1 : f19', 'rd : x19', 'fs1 == 1 and fe1 == 0x0c and fm1 == 0x24c and  fcsr == 0  #nosat']
Last Code Sequence : 
...
Last Coverpoint : ['rs1 : f18', 'rd : x18', 'fs1 == 1 and fe1 == 0x0c and fm1 == 0x24d and  fcsr == 0  #nosat']
Last Code Sequence : 
...
Last Coverpoint : ['rs1 : f17', 'rd : x17', 'fs1 == 1 and fe1 == 0x0c and fm1 == 0x24e and  fcsr == 0  #nosat']
Last Code Sequence : 
...
Last Coverpoint : ['rs1 : f16', 'rd : x16', 'fs1 == 1 and fe1 == 0x0c and fm1 == 0x24f and  fcsr == 0  #nosat']
Last Code Sequence : 
...
|---:|--------------------------|-------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------|
|   1|[0x80002214]<br>0x00003248|- mnemonic : fmv.x.h<br> - rs1 : f31<br> - rd : x31<br> - fs1 == 0 and fe1 == 0x0c and fm1 == 0x248 and  fcsr == 0  #nosat<br> |[0x80000120]:fmv.x.h t6, ft11<br> [0x80000124]:csrrs tp, fcsr, zero<br> [0x80000128]:sw t6, 0(ra)<br>     |
|   2|[0x8000221c]<br>0x00003249|- rs1 : f30<br> - rd : x30<br> - fs1 == 0 and fe1 == 0x0c and fm1 == 0x249 and  fcsr == 0  #nosat<br>                          |[0x8000013c]:fmv.x.h t5, ft10<br> [0x80000140]:csrrs tp, fcsr, zero<br> [0x80000144]:sw t5, 8(ra)<br>     |
|   3|[0x80002224]<br>0x0000324A|- rs1 : f29<br> - rd : x29<br> - fs1 == 0 and fe1 == 0x0c and fm1 == 0x24a and  fcsr == 0  #nosat<br>                          |[0x80000158]:fmv.x.h t4, ft9<br> [0x8000015c]:csrrs tp, fcsr, zero<br> [0x80000160]:sw t4, 16(ra)<br>     |
|   4|[0x8000222c]<br>0x0000324B|- rs1 : f28<br> - rd : x28<br> - fs1 == 0 and fe1 == 0x0c and fm1 == 0x24b and  fcsr == 0  #nosat<br>                          |[0x80000174]:fmv.x.h t3, ft8<br> [0x80000178]:csrrs tp, fcsr, zero<br> [0x8000017c]:sw t3, 24(ra)<br>     |
|   5|[0x80002234]<br>0x0000324C|- rs1 : f27<br> - rd : x27<br> - fs1 == 0 and fe1 == 0x0c and fm1 == 0x24c and  fcsr == 0  #nosat<br>                          |[0x80000190]:fmv.x.h s11, fs11<br> [0x80000194]:csrrs tp, fcsr, zero<br> [0x80000198]:sw s11, 32(ra)<br>  |
|   6|[0x8000223c]<br>0x0000324D|- rs1 : f26<br> - rd : x26<br> - fs1 == 0 and fe1 == 0x0c and fm1 == 0x24d and  fcsr == 0  #nosat<br>                          |[0x800001ac]:fmv.x.h s10, fs10<br> [0x800001b0]:csrrs tp, fcsr, zero<br> [0x800001b4]:sw s10, 40(ra)<br>  |
|   7|[0x80002244]<br>0x0000324E|- rs1 : f25<br> - rd : x25<br> - fs1 == 0 and fe1 == 0x0c and fm1 == 0x24e and  fcsr == 0  #nosat<br>                          |[0x800001c8]:fmv.x.h s9, fs9<br> [0x800001cc]:csrrs tp, fcsr, zero<br> [0x800001d0]:sw s9, 48(ra)<br>     |
|   8|[0x8000224c]<br>0x0000324F|- rs1 : f24<br> - rd : x24<br> - fs1 == 0 and fe1 == 0x0c and fm1 == 0x24f and  fcsr == 0  #nosat<br>                          |[0x800001e4]:fmv.x.h s8, fs8<br> [0x800001e8]:csrrs tp, fcsr, zero<br> [0x800001ec]:sw s8, 56(ra)<br>     |
|   9|[0x80002254]<br>0xFFFFB248|- rs1 : f23<br> - rd : x23<br> - fs1 == 1 and fe1 == 0x0c and fm1 == 0x248 and  fcsr == 0  #nosat<br>                          |[0x80000200]:fmv.x.h s7, fs7<br> [0x80000204]:csrrs tp, fcsr, zero<br> [0x80000208]:sw s7, 64(ra)<br>     |
|  10|[0x8000225c]<br>0xFFFFB249|- rs1 : f22<br> - rd : x22<br> - fs1 == 1 and fe1 == 0x0c and fm1 == 0x249 and  fcsr == 0  #nosat<br>                          |[0x8000021c]:fmv.x.h s6, fs6<br> [0x80000220]:csrrs tp, fcsr, zero<br> [0x80000224]:sw s6, 72(ra)<br>     |
|  11|[0x80002264]<br>0xFFFFB24A|- rs1 : f21<br> - rd : x21<br> - fs1 == 1 and fe1 == 0x0c and fm1 == 0x24a and  fcsr == 0  #nosat<br>                          |[0x80000238]:fmv.x.h s5, fs5<br> [0x8000023c]:csrrs tp, fcsr, zero<br> [0x80000240]:sw s5, 80(ra)<br>     |
|  12|[0x8000226c]<br>0xFFFFB24B|- rs1 : f20<br> - rd : x20<br> - fs1 == 1 and fe1 == 0x0c and fm1 == 0x24b and  fcsr == 0  #nosat<br>                          |[0x80000254]:fmv.x.h s4, fs4<br> [0x80000258]:csrrs tp, fcsr, zero<br> [0x8000025c]:sw s4, 88(ra)<br>     |
|  13|[0x80002274]<br>0xFFFFB24C|- rs1 : f19<br> - rd : x19<br> - fs1 == 1 and fe1 == 0x0c and fm1 == 0x24c and  fcsr == 0  #nosat<br>                          |[0x80000270]:fmv.x.h s3, fs3<br> [0x80000274]:csrrs tp, fcsr, zero<br> [0x80000278]:sw s3, 96(ra)<br>     |
|  14|[0x8000227c]<br>0xFFFFB24D|- rs1 : f18<br> - rd : x18<br> - fs1 == 1 and fe1 == 0x0c and fm1 == 0x24d and  fcsr == 0  #nosat<br>                          |[0x8000028c]:fmv.x.h s2, fs2<br> [0x80000290]:csrrs tp, fcsr, zero<br> [0x80000294]:sw s2, 104(ra)<br>    |
|  15|[0x80002284]<br>0xFFFFB24E|- rs1 : f17<br> - rd : x17<br> - fs1 == 1 and fe1 == 0x0c and fm1 == 0x24e and  fcsr == 0  #nosat<br>                          |[0x800002a8]:fmv.x.h a7, fa7<br> [0x800002ac]:csrrs tp, fcsr, zero<br> [0x800002b0]:sw a7, 112(ra)<br>    |
|  16|[0x8000228c]<br>0xFFFFB24F|- rs1 : f16<br> - rd : x16<br> - fs1 == 1 and fe1 == 0x0c and fm1 == 0x24f and  fcsr == 0  #nosat<br>                          |[0x800002c4]:fmv.x.h a6, fa6<br> [0x800002c8]:csrrs tp, fcsr, zero<br> [0x800002cc]:sw a6, 120(ra)<br>    |
|  17|[0x80002294]<br>0x00000000|- rs1 : f15<br> - rd : x15<br>                                                                                                 |[0x800002e0]:fmv.x.h a5, fa5<br> [0x800002e4]:csrrs tp, fcsr, zero<br> [0x800002e8]:sw a5, 128(ra)<br>    |
|  18|[0x8000229c]<br>0x00000000|- rs1 : f14<br> - rd : x14<br>                                                                                                 |[0x800002fc]:fmv.x.h a4, fa4<br> [0x80000300]:csrrs tp, fcsr, zero<br> [0x80000304]:sw a4, 136(ra)<br>    |
|  19|[0x800022a4]<br>0x00000000|- rs1 : f13<br> - rd : x13<br>                                                                                                 |[0x80000318]:fmv.x.h a3, fa3<br> [0x8000031c]:csrrs tp, fcsr, zero<br> [0x80000320]:sw a3, 144(ra)<br>    |
|  20|[0x800022ac]<br>0x00000000|- rs1 : f12<br> - rd : x12<br>                                                                                                 |[0x80000334]:fmv.x.h a2, fa2<br> [0x80000338]:csrrs tp, fcsr, zero<br> [0x8000033c]:sw a2, 152(ra)<br>    |
|  21|[0x800022b4]<br>0x00000000|- rs1 : f11<br> - rd : x11<br>                                                                                                 |[0x80000350]:fmv.x.h a1, fa1<br> [0x80000354]:csrrs tp, fcsr, zero<br> [0x80000358]:sw a1, 160(ra)<br>    |
